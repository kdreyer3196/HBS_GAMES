...
def init():
    ...
    folder_name = '230110_ModelA_Modules1-2'
    ...
    conditions_dictionary["model"] = 'model_A' #'modelA', 'model_D', 'model_Dns', 'model_DnH2s'
